...
%{
% following is hardcoded in adaptloop.c and currently, not even passed to the function from here
narginchk(2, 5)
...
inoutsig = OpenQual.Pemo.comp_adaptloop(inoutsig,fs,limit,minlvl);

% output value validation
mustBeNonNan(inoutsig);
mustBeFinite(inoutsig);